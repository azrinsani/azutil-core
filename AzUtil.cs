    ...
    public class Utilities : IAzUtil
    {
        ...
        public async Task SendMail(SmtpSettings sMtp)
        {
            SmtpClient client = new SmtpClient(sMtp.Host, sMtp.Port)
            {
                ...
                Credentials = new NetworkCredential(sMtp.Username, sMtp.Password) //tHIS PASSWORD WAS generated by google special app access https://myaccount.google.com/apppasswords
            };
